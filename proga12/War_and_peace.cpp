...
int main(){
    ...
    std::string tom1 = "D:\\proga\\proga12\\tom1.txt";
    std::string tom2 = "D:\\proga\\proga12\\tom2.txt";
    std::string tom3 = "D:\\proga\\proga12\\tom3.txt";
    std::string tom4 = "D:\\proga\\proga12\\tom4.txt";
